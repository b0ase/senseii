...
const SatoshiAgent = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: "Hello! I'm Satoshi, your AI guide to understanding Bitcoin as it was originally designed. I embody the knowledge and vision of the original Bitcoin whitepaper and the true scaling solutions. What would you like to learn about Bitcoin SV today?",
      sender: 'satoshi',
      timestamp: new Date(),
    }
  ])
  ...
  return (
    <section id="satoshi-agent" className="section-padding bg-gradient-to-br from-slate-800 to-slate-900">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="relative">
              <motion.div
                ...
                className="absolute inset-0 rounded-full bg-gradient-to-r from-bitcoin-orange to-bitcoin-yellow opacity-20 blur-xl"
              />
              <div className="relative bg-gradient-to-br from-bitcoin-orange to-bitcoin-dark p-4 rounded-full">
