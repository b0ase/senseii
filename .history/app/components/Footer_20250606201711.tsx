...
const Footer = () => {
  const platformModules = [
    { name: 'Kitana (Smart Contracts)', href: '#kitana' },
    { name: 'Shuriken (IP Capture)', href: '#shuriken' },
    { name: 'MetaGraph Social', href: '#metagraph' },
    { name: 'EWS Search', href: '#search' },
    { name: 'NFT Camera', href: '#camera' },
    { name: 'Stream Module', href: '#stream' }
  ]

  const businessTools = [
    { name: 'Senseii Jobs', href: '#jobs' },
    { name: 'Senseii Teams', href: '#teams' },
    { name: 'Contract Market', href: '#contracts' },
    { name: 'Share Module', href: '#share' },
    { name: 'Legal Module', href: '#legal' },
    { name: 'Wallet & Ledger', href: '#wallet' }
  ]
    ...
    <footer className="bg-slate-900 border-t border-white/10">
      <div className="container-custom section-padding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:text-bitcoin-orange transition-colors duration-300"
                  aria-label={label}
                >
          ...
          {/* Platform Modules */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-6">Core Platform</h3>
          ...
          {/* Business Tools */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-6">Business Tools</h3>
            <ul className="space-y-3">
        ...
        >
          <h3 className="text-2xl font-bold gradient-text mb-4">
            Our Vision: Replace Google's Infrastructure
          </h3>
          <p className="text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Senseii aims to break Google's monopoly by creating hundreds of competing search engines 
            powered by Economically Weighted Search (EWS). Every digital asset becomes tokenized IP, 
            every interaction creates value, and every user becomes an entrepreneur in the MetaNet economy.
          </p>
        </motion.div>
